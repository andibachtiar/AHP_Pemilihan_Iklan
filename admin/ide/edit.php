...
<div class="widget wgreen">
                ...
                <div class="widget-head">
                  <div class="pull-left">Forms Edit Ide</div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    <!-- Form starts.  -->
                    <form id="form_reg" name="form_reg" action="ide/edit_post.php" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
...
?>
  <option value="<?php echo $data_row['id_project']; ?>" <?php if($data_row_cek['id_project']==$data_row['id_project']){echo "selected";} ?>><?php echo $data_row['nm_project']; ?></option>
  <?php
}
}
?>
...
?>
  <option value="<?php echo $data_row_c['id_creator']; ?>" <?php if($data_row_cek['id_creator']==$data_row_c['id_creator']){echo "selected";} ?>><?php echo $data_row_c['nm_tim']; ?></option>
  <?php
}
}
?>
...
<div class="form-group">
  ...
  <div class="col-lg-8">
    <input type="text" class="form-control" name="tgl_ide" id="tgl_ide" value="<?php echo $data_row_cek['tgl_ide']; ?>">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-lg-8">
    <textarea class="form-control" rows="3" name="talent" id="talent"><?php echo $data_row_cek['talent']; ?></textarea>
  </div>
</div> 
...
<div class="form-group">
  ...
  <div class="col-lg-8">
    <textarea class="form-control" rows="3" name="wardrop" id="wardrop"><?php echo $data_row_cek['wardrop']; ?></textarea>
  </div>
</div> 
...
<div class="form-group">
  ...
  <div class="col-lg-8">
    <textarea class="form-control" rows="3" name="lokasi" id="lokasi"><?php echo $data_row_cek['lokasi']; ?></textarea>
  </div>
</div> 
...
<div class="form-group">
  ...
  <div class="col-lg-8">
    <textarea class="form-control" rows="3" name="tempat" id="tempat"><?php echo $data_row_cek['tempat']; ?></textarea>
  </div>
</div> 
...
<div class="form-group">
  ...
  <div class="col-lg-8">
    <textarea class="form-control" rows="3" name="brodcase" id="brodcase"><?php echo $data_row_cek['brodcase']; ?></textarea>
  </div>
</div> 
...
<div class="form-group">
  ...
  <div class="col-lg-8">
    <textarea class="form-control" rows="3" name="durasi" id="durasi"><?php echo $data_row_cek['durasi']; ?></textarea>
  </div>
</div> 
